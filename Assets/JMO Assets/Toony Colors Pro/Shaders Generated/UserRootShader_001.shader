...
Shader "Toony Colors Pro 2/User/RootShader_001"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(ver:"2.9.11";unity:"2022.3.45f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","RIM","SPEC_PBR_GGX","SPECULAR","RIM_DIR","SUBSURFACE_AMB_COLOR","SHADOW_LINE_CRISP_AA","SHADOW_LINE","DIFFUSE_TINT","SKETCH_AMBIENT","SKETCH_PROGRESSIVE_SMOOTH","OUTLINE","OUTLINE_LIGHTING_WRAP","GLOSSY_REFLECTIONS","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 02503767626a10815cc48a43d22ab202 */
